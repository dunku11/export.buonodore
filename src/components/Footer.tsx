...
export default function Footer() {
  return (
    <footer className="bg-stone-50 border-t border-stone-200 py-16 px-6 relative z-10">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        
        <div className="space-y-4 md:col-span-2">
          <span className="font-serif text-2xl tracking-[0.2em] font-light text-stone-900 select-none">
            BUONO ODRE
          </span>
          ...
          <div className="text-[10px] text-stone-500 font-light flex flex-col gap-1.5 pt-2 font-mono">
        ...
        <div>
          <h5 className="font-serif text-sm text-stone-900 tracking-wider mb-4 uppercase">Direct Navigation</h5>
          <ul className="space-y-2 text-[11px] font-light text-stone-600 font-sans">
            ...
            <li><a href="#contact" className="hover:text-bronze-primary transition-colors">B2B RFQ Form</a></li>
          </ul>
        </div>

        <div>
          <h5 className="font-serif text-sm text-stone-900 tracking-wider mb-4 uppercase">Quality Compliance</h5>
          <ul className="space-y-2 text-[11px] font-light text-stone-600 font-sans font-light">
      ...
      <div className="max-w-6xl mx-auto border-t border-stone-200 pt-8 flex flex-col md:flex-row items-center justify-between text-[10px] text-stone-500 font-light font-mono gap-4">
        <div>
          © {new Date().getFullYear()} BUONO ODRE LTD. All Rights Reserved. Patented Designs.
        </div>
        <div className="flex gap-4">
          <span className="hover:text-stone-900 cursor-pointer">Export Terms</span>
          <span>•</span>
          <span className="hover:text-stone-900 cursor-pointer">Privacy Policy</span>
          <span>•</span>
          <span className="hover:text-stone-900 cursor-pointer">EU Customs Alliance</span>
        </div>
      </div>
    </footer>
  );
